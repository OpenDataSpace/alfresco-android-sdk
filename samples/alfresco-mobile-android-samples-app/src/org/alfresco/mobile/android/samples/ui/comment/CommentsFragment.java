 ...
 ******************************************************************************/
package org.alfresco.mobile.android.samples.ui.comment;
...
public class CommentsFragment extends CommentFragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        init(v, R.string.document_comments_nocomments);
        ...
        bAdd.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    MessengerManager.showToast(getActivity(), R.string.document_comments_nocomments);
                }
            }
        });
    ...
    public void onStart()
    {
        UIUtils.setFragmentTitle(getActivity(), getText(R.string.document_comments_header).toString());
        super.onStart();
    }
}
