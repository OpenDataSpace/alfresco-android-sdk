...
public class CloudServiceRegistry extends AbstractServiceRegistry
{
    ...
    public ActivityStreamService getActivityStreamService()
    {
        ...
        {
            this.activityStreamService = new CloudActivityStreamServiceImpl(session);
        }
    ...
    public RatingService getRatingService()
    {
        ...
        {
            this.ratingsService = new CloudRatingsServiceImpl(session);
        }
    ...
    public PersonService getPersonService()
    {
        ...
        {
            this.personService = new CloudPersonServiceImpl(session);
        }
    ...
    public WorkflowService getWorkflowService()
    {
        ...
        {
            this.workflowService = new CloudWorkflowServiceImpl(session);
        }
