...
public interface ActivityStreamService extends Service
{
     ...
     * doesn't exist.
     * @throws org.alfresco.mobile.android.api.exceptions.AlfrescoServiceException : If username is undefined or if network
     ...
     * @throws org.alfresco.mobile.android.api.exceptions.AlfrescoServiceException : If siteName is undefined or if network
     *                                                                             or internal problems occur during the process.
     */
