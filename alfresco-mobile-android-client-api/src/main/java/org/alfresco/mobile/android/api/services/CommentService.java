...
public interface CommentService extends Service
{
     ...
     * @throws org.alfresco.mobile.android.api.exceptions.AlfrescoServiceException :  : if node doesn't
     *                                                                             exist.
     * @throws org.alfresco.mobile.android.api.exceptions.AlfrescoServiceException : ErrorCodeRegistry.GENERAL_UNKNOWN : If network problems
     ...
     * node.
     * @throws org.alfresco.mobile.android.api.exceptions.AlfrescoServiceException : If node is not defined or if network
     ...
     * @throws org.alfresco.mobile.android.api.exceptions.AlfrescoServiceException : If content or node is not defined or
     ...
     * @throws org.alfresco.mobile.android.api.exceptions.AlfrescoServiceException : If content or comment is not defined
     ...
     *
     * @throws org.alfresco.mobile.android.api.exceptions.AlfrescoServiceException : If comment is not defined or if
